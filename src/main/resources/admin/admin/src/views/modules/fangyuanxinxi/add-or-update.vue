<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="申请文件" prop="shenqingwenjian">
          <file-upload
          tip="点击上传申请文件"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.shenqingwenjian" label="申请文件" prop="shenqingwenjian">
            <el-button type="text" size="small" @click="download(ruleForm.shenqingwenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="申请要求" prop="shenqingyaoqiu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.shenqingyaoqiu" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shenqingyaoqiu" label="申请要求" prop="shenqingyaoqiu">
                    <span v-html="ruleForm.shenqingyaoqiu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dizhi = true;
          ...
          if(o=='shenqingyaoqiu'){
            this.ruleForm.shenqingyaoqiu = obj[o];
	    this.ro.shenqingyaoqiu = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.shenqingyaoqiu = this.ruleForm.shenqingyaoqiu.replace(reg,'../../../springbooth6iu7/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
