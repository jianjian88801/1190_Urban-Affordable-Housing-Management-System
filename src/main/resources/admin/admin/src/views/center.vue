  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item v-if="flag=='yonghu'"  label="婚姻" prop="hunyin">
          <el-select v-model="ruleForm.hunyin" placeholder="请选择婚姻">
            <el-option
                v-for="(item,index) in yonghuhunyinOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
...
export default {
  ...
  mounted() {
    ...
    this.yonghuhunyinOptions = "已婚,未婚".split(',')
  },
  methods: {
